        ...
        <div className="max-w-[1500px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 relative z-10">
          ...
          <div className="w-full px-4 pt-10 pt-safe md:px-10 lg:px-14 pb-4">
            ...
            <div className="grid grid-cols-3 gap-3 md:gap-4 mb-8 relative z-20">
               <a href="/" onClick={(e) => { e.preventDefault(); triggerTransition('/', 'food'); }} className="relative flex flex-col items-center justify-center gap-3 py-6 rounded-3xl bg-[#141416]/80 light:bg-white backdrop-blur-2xl border border-white/5 light:border-white shadow-xl light:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.06)] hover:shadow-2xl light:hover:shadow-[0_20px_40px_-5px_rgba(0,0,0,0.08)] hover:-translate-y-1 active:scale-95 transition-all duration-400 group overflow-hidden cursor-pointer">
                  <div className="absolute inset-0 bg-gradient-to-b from-white/[0.02] to-transparent light:from-orange-50/30 light:to-transparent pointer-events-none" />
                  <div className="relative w-14 h-14 rounded-full bg-gradient-to-br from-[#C9A84C]/20 to-[#C9A84C]/5 light:from-orange-100 light:to-red-50 border border-[#C9A84C]/20 light:border-orange-200/50 flex items-center justify-center text-2xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-inner light:shadow-[inset_0_2px_10px_rgba(255,255,255,0.8)]">
                    🍔
                  </div>
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white light:text-gray-900 relative z-10 group-hover:text-[#C9A84C] light:group-hover:text-[#EF4F5F] transition-colors">Food</span>
               </a>
               <a href="/pg" onClick={(e) => { e.preventDefault(); triggerTransition('/pg', 'pg'); }} className="relative flex flex-col items-center justify-center gap-3 py-6 rounded-3xl bg-[#141416]/80 light:bg-white backdrop-blur-2xl border border-white/5 light:border-white shadow-xl light:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.06)] hover:shadow-2xl light:hover:shadow-[0_20px_40px_-5px_rgba(0,0,0,0.08)] hover:-translate-y-1 active:scale-95 transition-all duration-400 group overflow-hidden cursor-pointer">
                  <div className="absolute inset-0 bg-gradient-to-b from-white/[0.02] to-transparent light:from-blue-50/30 light:to-transparent pointer-events-none" />
                  <div className="relative w-14 h-14 rounded-full bg-gradient-to-br from-white/10 to-transparent light:from-blue-100 light:to-cyan-50 border border-white/10 light:border-blue-200/50 flex items-center justify-center text-2xl group-hover:scale-110 group-hover:-rotate-6 transition-all duration-500 shadow-inner light:shadow-[inset_0_2px_10px_rgba(255,255,255,0.8)]">
                    🏢
                  </div>
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white light:text-gray-900 relative z-10 group-hover:text-[#C9A84C] light:group-hover:text-[#EF4F5F] transition-colors">Hostels</span>
               </a>
               <a href="/bikepool" onClick={(e) => { e.preventDefault(); triggerTransition('/bikepool', 'bikepool'); }} className="relative flex flex-col items-center justify-center gap-3 py-6 rounded-3xl bg-[#141416]/80 light:bg-white backdrop-blur-2xl border border-white/5 light:border-white shadow-xl light:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.06)] hover:shadow-2xl light:hover:shadow-[0_20px_40px_-5px_rgba(0,0,0,0.08)] hover:-translate-y-1 active:scale-95 transition-all duration-400 group overflow-hidden cursor-pointer">
                  <div className="absolute inset-0 bg-gradient-to-b from-white/[0.02] to-transparent light:from-purple-50/30 light:to-transparent pointer-events-none" />
                  <div className="relative w-14 h-14 rounded-full bg-gradient-to-br from-white/10 to-transparent light:from-purple-100 light:to-pink-50 border border-white/10 light:border-purple-200/50 flex items-center justify-center text-2xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-inner light:shadow-[inset_0_2px_10px_rgba(255,255,255,0.8)]">
                    🏍️
                  </div>
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white light:text-gray-900 relative z-10 group-hover:text-[#C9A84C] light:group-hover:text-[#EF4F5F] transition-colors">Co-Ride</span>
               </a>
            </div>
